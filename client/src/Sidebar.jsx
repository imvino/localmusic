import { Home, Mic2, Disc3, Music, Search } from 'lucide-react'
...
export default function Sidebar({ currentView, onNavigate, searchQuery, onSearch }) {
  return (
      ...
      <div className="p-5 flex flex-col gap-6 overflow-y-auto flex-1">
        ...
        <div className="flex flex-col gap-0.5">
          ...
          {NAV_ITEMS.map(({ id, label, icon: Icon }) => (
            ...
            >
              <Icon size={17} className={currentView === id ? 'text-[#fc3c44]' : ''} />
              {label}
            </button>
          ))}
        </div>
